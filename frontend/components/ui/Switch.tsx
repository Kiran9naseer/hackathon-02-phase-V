...
export const Switch = ({ checked, onCheckedChange, className = "", disabled }: SwitchProps) => {
    return (
        ...
        focus-visible:ring-offset-2 focus-visible:ring-offset-surface-dark disabled:cursor-not-allowed disabled:opacity-50 
        ${checked ? "bg-primary-500" : "bg-primary-500/10"}
        ${className}
      `}
        >
            <span
          ...
          ${checked ? "bg-white" : "bg-primary-500/40"}
        `}
            />
        </button>
    );
